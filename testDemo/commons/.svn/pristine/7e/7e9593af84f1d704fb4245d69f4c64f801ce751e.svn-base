...
import com.codyy.commons.utils.MapUtil;

public class CommonsConstant {

	public static final String P3PSTRING = "CP=\"CURa ADMa DEVa PSAo PSDo OUR BUS UNI PUR INT DEM STA PRE COM NAV OTC NOI DSP COR\"";// 设置浏览器隐私级别
	...
	public static final String PREPARE_OFFICE = "OFFICE";// office编辑
	public static final String PREPARE_RICH_TEXT = "RICH_TEXT";// 富文本框
	public static final String PREPARE_SYSTEM_TEMPLATE = "SYSTEM";//个人备课系统模板
	public static final String PREPARE_PERSONAL_TEMPLATE = "PERSONAL";//个人备课我的模板
	public static final String PREPARE_IMAGE = "prepareImage";//个人备课学科素材
	public static final String PREPARE_LESSONPLAN = "prepareLessonPlan";//个人备课教案
	public static final String PREPARE_TEMPLATE = "prepareTemplate";//个人备课模板
	// DELETE_FLAG未删除
	// LOCKED未锁定可以登录
	...
	// 访问者类型（游客，访客，本人）
	//public static final String VISITOR_TYPE_OWNER = "OWNER"; //本人(拥有者)
	//public static final String VISITOR_TYPE_VISITOR = "VISITOR"; //访客
	//public static final String VISITOR_TYPE_PASSENGER = "PASSENGER"; //游客
	// 被访问者类型
	public static final String VISIT_TYPE_CLASS = "CLASS"; //访问班级
	
	// BASE_USER的用户类型
	public static final String USER_TYPE_AREA_USER = "AREA_USR";// 行政机构用户
	public static final String USER_TYPE_SCHOOL_USER = "SCHOOL_USR";// 学校用户(学校管理员)
	...
	public static final String USER_TYPE_CLASS = "CLASS";// 班级
	...
	// 教学反思--反思类型
	public static final String RETHINK_CLASS = "CLASS" ;	// 课时反思
	public static final String RETHINK_DAY = "DAY" ;	// 日反思
	public static final String RETHINK_WEEK = "WEEK" ;	// 周反思
	public static final String RETHINK_MONTH = "MONTH" ;	// 月反思
	public static final String RETHINK_SEMESTER_MIDDLE = "SEMESTER_MIDDLE" ;	// 期中反思
	public static final String RETHINK_SEMESTER_END = "SEMESTER_END" ;	// 期末反思
	
	//open 账号审批类型
	public static final String ACCOUNT_STATUS_REGISTER = "REGISTER";//已注册
	public static final String ACCOUNT_STATUS_SEND_EMAIL_CODE = "SEND_EMAIL_CODE";//已发邮箱验证
	public static final String ACCOUNT_STATUS_VALIDATE_EMAIL_CODE = "VALIDATE_EMAIL_CODE";//已验证邮箱
	public static final String ACCOUNT_STATUS_PERFECT_INFO = "PERFECT_INFO";//完善信息
	public static final String ACCOUNT_STATUS_APPROVED = "APPROVED"; //通过审核
	public static final String ACCOUNT_STATUS_APPROVEING = "APPROVEING"; //审核中
	public static final String ACCOUNT_STATUS_REJECT = "REJECT"; //未通过审核
	...
	//学科默认缩列图
	public static final String SUBJECT_PIC_DEFAULT = "subjectDefault.png";
	// 批阅过后的课堂作业名字包含字符
	...
	public static final String SESSION_USER = "SESSION_USER"; // SessionUser对象,
																// 用于用户中心,资源,评课,在线课堂模块
	public static final String SESSION_SCHOOLNAME = "SESSION_SCHOOLNAME";//用于授课平台登录后学校名称放到session变量
	...
	public static final String SESSION_RES_FILE_ITEM = "SESSION_RES_FILE_ITEM";// 资源项目中上传的文件会话key
	...
	public static final String BASE_CLASS_TYPE_MONITOR = "MONITOR";// 班长
	public static final String BASE_CLASS_TYPE_MANAGER = "MANAGER";// 班级管理员
	...
	public static final String INFO_TYPE_NEWS_DRAFT = "NEWS_DRAFT"; // 新闻草稿

	public static final String INFO_TYPE_ANNOUNCEMENT = "ANNOUNCEMENT"; // 公告
	public static final String INFO_TYPE_NOTICE = "NOTICE"; // 通知

	public static final String INFO_TYPE_NOTICE_ANNOUNCEMENT_DRAFT = "NOTICE_ANNOUNCEMENT_DRAFT"; // 通知、公告的草稿箱

	// 圈组常量
	//圈组类型
	public static final String GROUP_TYPE_TEACH = "TEACH";// 教研组
	public static final String GROUP_TYPE_INTEREST = "INTEREST";// 兴趣组
	// 圈组审批状态
	public static final String GROUP_STATUS_WAIT = "WAIT";// 等待
	public static final String GROUP_STATUS_APPROVED = "APPROVED";// 通过
	public static final String GROUP_STATUS_REJECT = "REJECT";// 拒绝
	// 圈组用户角色
	public static final String GROUP_USER_CREATOR = "CREATOR";// 创建者
	public static final String GROUP_USER_MANAGER = "MANAGER";// 组长
	public static final String GROUP_USER_MEMBER = "MEMBER";// 成员
	//圈组推荐类型
	public static final String GROUP_RECOMMEND_TYPE_AREA = "AREA";//地区
	public static final String GROUP_RECOMMEND_TYPE_SCHOOL = "SCHOOL";//学校
	//圈组推荐位置
	public static final String GROUP_RECOMMEND_LOCATION_HOME = "HOME";//门户圈组库
	public static final String GROUP_RECOMMEND_LOCATION_SIDE = "SIDE";//侧边栏
	//圈组子模块标记
	public static final String GROUP_BLOG = "GROUP_BLOG";//博文子模块
	public static final String GROUP_PREPARATION = "GROUP_PREPARATION";//集体备课子模块
	public static final String GROUP_PERPRELESSON = "GROUP_PERPRELESSON";//个人备课子模块
	// 资讯创建者所属机构
	public static final String CREATE_TYPE_AREA = "AREA"; // 区域
	public static final String CREATE_TYPE_SCHOOL = "SCHOOL"; // 学校
	//博文
	public static final String BLOG_VIEW_COUNT = "VIEW_COUNT"; //阅读数
	public static final String BLOG_COMMENT_COUNT = "COMMENT_COUNT"; //评论数
	public static final String BLOG_HANDLER_YES_FALG = "Y"; //可以对博文进行操作
	public static final String BLOG_HANDLER_NO_FLAG = "N"; //不可以对博文进行操作
	public static final String BLOG_SHARE_CLASS = "CLASS"; //博文分享到班级
	public static final String BLOG_SHARE_SCHOOL = "SCHOOL"; //博文分享到学校
	public static final String GROUP_BLOG_TEACH = "GROUP_BLOG_TEACH"; //圈组博文标志
	public static final String GROUP_BLOG_INTEREST = "GROUP_BLOG_INTEREST"; //圈组博文标志
	...
	public static final String MEETING_TYPE_ONLINE_TUTOR = "ONLINE_TUTOR"; //在线辅导
	public static final String MEETING_TYPE_TUTOR_CLASSROOM = "TUTOR_CLASSROOM"; //辅导室
	public static final String MEETING_TYPE_GRP_PREPARE_LESSON = "GRP_PREPARE_LESSON"; //圈组集体会议
	public static final String MEETING_TYPE_GRP_VIDEO_MEETING = "GRP_VIDEO_MEETING"; //圈组视频会议
	...
	public static final String MEETING_MEMBER_TYPE_TEACHER = "TEACHER";//　老师
	public static final String MEETING_MEMBER_TYPE_STUDENT = "STUDENT";//　学生
	// 会议参会者登录信息
	...
	// 移动端视频会议用户角色
	public static final String MOBILE_MEET_USER_ROLE_MAIN = "0"; // 主讲
	public static final String MOBILE_MEET_USER_ROLE_SPEAKER = "1"; // 发言人
	public static final String MOBILE_MEET_USER_ROLE_JOIN = "2"; // 参会者
	public static final String MOBILE_MEET_USER_ROLE_GUEST = "4"; // 来宾
	public static final String MOBILE_MEET_USER_ROLE_WATCH = "3"; // 观摩

	// 视频切片来源类型
	public static final String SLICE_SOURCE_LIVE_APPOINTMENT = "LIVE_APPOINTMENT"; // 直录播
																					// 0
	public static final String SLICE_SOURCE_ONLINE_CLASS = "ONLINE_CLASS"; // 在线课堂
																			// 1
	public static final String SLICE_SOURCE_RESOURCE = "RESOURCE"; // 资源 2

	// 视频切片的状态
	public static final String SLICE_STATUS_SUCCESS = "SUCCESS";
	public static final String SLICE_STATUS_PROGRESS = "PROGRESS";
	public static final String SLICE_STATUS_FAILED = "FAILED";
	
	// 视频截图状态
	public static final String PRINTSCREEN_SUCCESS = "SUCCESS";
	public static final String PRINTSCREEN_PROGRESS = "PROGRESS";
	public static final String PRINTSCREEN_FAILED = "FAILED";

	// 视频标注的状态
	public static final String POINI_STATUS_INIT = "INIT";
	public static final String POINT_STATUS_SUCCESS = "SUCCESS";
	public static final String POINT_STATUS_PROGRESS = "PROGRESS";
	public static final String POINT_STATUS_FAILED = "FAILED";
	
	//转换状态
	public static final String TRANS_STATUS_INIT = "INIT";
	public static final String TRANS_STATUS_SUCCESS = "SUCCESS";
	public static final String TRANS_STATUS_PROGRESS = "PROGRESS";
	...
	public static final String BASE_CLASS_STAUTS_GRADUATED = "GRADUATED";
	public static final String BASE_CLASS_STAUTS_UNGRADUATED = "UNGRADUATED";
	public static final String BASE_CLASS_STAUTS_DISSOLVED = "DISSOLVED";


	/********************* 录制视频相关常量定义结束 *********************/

	// 作业分配范围/接收人类型：CUSTOM/自定义, DEFAULT/默认
	public static final String HOMEWORK_ASSIGN_TYPE_CUSTOM = "CUSTOM";
	public static final String HOMEWORK_ASSIGN_TYPE_DEFAULT = "DEFAULT";

	// 批阅方式：TEACHER/老师批阅，STU_EACH_OTHER/学生随机互批，STU_SPECIFIED/指定学生批阅
	public static final String HOMEWORK_READ_OVER_TYPE_TEACHER = "TEACHER";
	public static final String HOMEWORK_READ_OVER_TYPE_STU_EACH_OTHER = "STU_EACH_OTHER";
	public static final String HOMEWORK_READ_OVER_TYPE_STU_SPECIFIED = "STU_SPECIFIED";

	// 状态：已提交/END, 未提交/PROGRESS
	public static final String HOMEWORK_RECEIVE_STU_STATUS_END = "END";
	public static final String HOMEWORK_RECEIVE_STU_STATUS_PROGRESS = "PROGRESS";
	
	//状态：待布置/INIT, 待批阅/PROGRESS, 已批阅/END
	public static final String HOMEWORK_STATUS_INIT = "INIT";
	public static final String HOMEWORK_STATUS_PROGRESS = "PROGRESS";
	public static final String HOMEWORK_STATUS_END = "END";

	// 习题类型：单选题/SINGLE_CHOICE, 多选题/MULTI_CHOICE, 判断题/JUDEMENT,
	// 填空题/FILL_IN_BLANK, 问答题/ASK_ANSWER, 计算题/COMPUTING
	...
	public static final String QUESTION_TYPE_JUDEMENT = "JUDEMENT";
	public static final String QUESTION_TYPE_FILL_IN_BLANK = "FILL_IN_BLANK";
	public static final String QUESTION_TYPE_ASK_ANSWER = "ASK_ANSWER";
	public static final String QUESTION_TYPE_COMPUTING = "COMPUTING";
	public static Map<String,String> QUESTION_TYPE_MAP = MapUtil.newLinkedHashMap();
	static{
		QUESTION_TYPE_MAP.put(QUESTION_TYPE_SINGLE_CHOICE, "单选题");
		QUESTION_TYPE_MAP.put(QUESTION_TYPE_MULTI_CHOICE, "多选题");
		QUESTION_TYPE_MAP.put(QUESTION_TYPE_JUDEMENT, "判断题");
		QUESTION_TYPE_MAP.put(QUESTION_TYPE_FILL_IN_BLANK, "填空题");
		QUESTION_TYPE_MAP.put(QUESTION_TYPE_ASK_ANSWER, "问答题");
		QUESTION_TYPE_MAP.put(QUESTION_TYPE_COMPUTING, "计算题");
	}
	
	//填空题答案类型，独立答案/INDEPENDENT, 组合答案/COMBINATION
	public static final String QUESTION_FILL_IN_ANSWER_TYPE_INDEPENDENT = "INDEPENDENT";
	public static final String QUESTION_FILL_IN_ANSWER_TYPE_COMBINATION = "COMBINATION";
	
	//题目难易程度
	public static final String QUESION_DIFFICULTY_EASY = "EASY"; //容易
	public static final String QUESION_DIFFICULTY_LITTLE_EASY = "LITTLE_EASY";//较容易
	public static final String QUESION_DIFFICULTY_NORMAL = "NORMAL";//一般
	public static final String QUESION_DIFFICULTY_LITTLE_DIFFICULT = "LITTLE_DIFFICULT";//较难
	public static final String QUESION_DIFFICULTY_DIFFICULT = "DIFFICULT";//难
	
	public static Map<String,String> QUESION_DIFFCULTY_MAP = MapUtil.newLinkedHashMap();
	static{
		QUESION_DIFFCULTY_MAP.put(QUESION_DIFFICULTY_EASY, "容易");
		QUESION_DIFFCULTY_MAP.put(QUESION_DIFFICULTY_LITTLE_EASY, "较容易");
		QUESION_DIFFCULTY_MAP.put(QUESION_DIFFICULTY_NORMAL, "一般");
		QUESION_DIFFCULTY_MAP.put(QUESION_DIFFICULTY_LITTLE_DIFFICULT, "较难");
		QUESION_DIFFCULTY_MAP.put(QUESION_DIFFICULTY_DIFFICULT, "难");
	}
	
	//题目来源
	public static final String QUESION_SOURCE_PUBLIC = "PUBLIC";
	public static final String QUESION_SOURCE_PRIVATE = "PRIVATE";
	public static final String QUESION_SOURCE_FAVORITE = "FAVORITE";
	public static Map<String,String> QUESION_SOURCE_MAP = MapUtil.newLinkedHashMap();
	static{
		QUESION_SOURCE_MAP.put(QUESION_SOURCE_PRIVATE, "我的题库");
		QUESION_SOURCE_MAP.put(QUESION_SOURCE_PUBLIC, "共享题库");
		QUESION_SOURCE_MAP.put(QUESION_SOURCE_FAVORITE, "收藏习题");
	}
	
	//选项答案分割符
	public static final String QUESTION_SEPERATE = "∷";
	
	public static boolean isObjectiveQuestion(String type){
		if(QUESTION_TYPE_SINGLE_CHOICE.equals(type) ||
				QUESTION_TYPE_MULTI_CHOICE.equals(type) ||
				QUESTION_TYPE_JUDEMENT.equals(type) ||
				QUESTION_TYPE_FILL_IN_BLANK.equals(type)){
			return true;
		}
		return false;
	}
	...
	public enum ResourceDeleteFlagEnum {
		DELETE_NOT_DELETE("DELETE_NOT_DELETE", "未删除"), DELETE_BY_MANAGER("DELETE_BY_MANAGER", "管理员删除"), DELETE_BY_USER("DELETE_BY_USER", "用户删除");
	...
	public static String getMeetingType(String type) {
		if (StringUtils.isNotBlank(type)) {
			if (type.equals(MEETING_TYPE_VIDEO_MEETING)) {
				...
				return "集体备课";
			} else if (type.equals(MEETING_TYPE_ONLINE_TUTOR)) {
				return "在线辅导";
			}
		}
		return null;
