 ...
 * Function: 课堂作业上传Servlet
 * Reason: TODO ADD REASON(可选)
 * date: 2015年7月8日 下午4:58:17
 * 
 * @author wangqiqi 
 * @version  
 * @since JDK 1.7
 */
public class BaseClassWorkUploadServlet extends HttpServlet {

	
	private static final long serialVersionUID = -7163921304268364778L;
	private Logger logger = Logger.getLogger(BaseClassWorkUploadServlet.class);
	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public BaseClassWorkUploadServlet() {
		super();
	}
	...
	public static File createFile(String classId,String clsClassroomId,String suffix) throws IOException {
		...
		ImageConfig config = SpringContext.getBean(ImageConfig.class);
		String filePath = buildFile(config.getFolder(),classId,clsClassroomId, uuid + suffix);
