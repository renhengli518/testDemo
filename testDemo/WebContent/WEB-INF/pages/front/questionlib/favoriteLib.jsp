...
<body class="mainIndex">
   ...
   /*  $("#pageNavi").on("click",function(){
	...
	function searchQuestions() {
		var url  = '${root}/questionLib/searchFavoriteList.do';
	...
	function copyQuestion(obj){
		...
		window.open("${root}/questionLib/toeditquestion.html?questionId="+queQuestionId);
	}
		...
		if(len>0){
			for(var i = 0; i< len; i++){
				...
				if(qstObj.queFavoriteId!=null && qstObj.queFavoriteId!=""){
					...
					qstHtml +='<b id="'+qstObj.queQuestionId+'" style="cursor:pointer;" onclick="copyQuestion(this)" class="fr fontNormal toCopy mr20">复制</b>';
				}
				qstHtml += '</p>';
