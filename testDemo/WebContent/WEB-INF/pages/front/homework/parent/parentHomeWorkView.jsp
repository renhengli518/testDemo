		...
		<div class="content">
			<div class="content-in">
				<div class="breadCrumb">
					<a href="${root}/parentWork/toParentWork.do?studentUserId=${userId}">作业</a><span class="nextlevel">></span><span class="currentLevel">查看作业 </span>
				</div>
							...
							<div class="TaskWrap teaComments mt30">
								...
								<ul class="commonUL">
									...
									<li>
											...
											<span class="cont"> 
												<c:forEach
														items="${workQuestionInfo.workReceiveDoc}" var="file">
														<span class="lightBlue">${file.docName}</span>
												<span class="ml30">大小：
													<c:if test="${file.docSize/1024/1024 >= 1}">
										<fmt:formatNumber type="number" value="${file.docSize/1024/1024}" maxFractionDigits="2"/>M
