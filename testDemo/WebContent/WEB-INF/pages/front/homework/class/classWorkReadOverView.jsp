		...
		<div class="content">
			<div class="content-in">
				<div class="breadCrumb">
					<a href="${root}/classWork/toClassWorkList.do">作业</a>
					<span class="nextlevel">></span>
					<a href="javascript:;">作业统计</a>
					<span class="nextlevel">></span>
					<span class="currentLevel">查看批阅</span>
				</div>
							...
							<c:if test="${!empty homeWorkQuestionInfo.textQueContent}">
								...
								<c:if test="${!empty homeWorkQuestionInfo.workDocList }">
									<div class="TaskWrap teaComments mt30">
										...
										<ul class="commonUL">
											<li><label class="text  fontBold">附件作业：</label> <span
												class="cont"> <c:forEach
														items="${homeWorkQuestionInfo.workDocList}" var="file">
