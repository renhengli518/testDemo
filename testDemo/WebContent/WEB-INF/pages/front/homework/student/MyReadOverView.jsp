...
var config = {
		node:$id("pager"),
		url:"${root}/studentWork/ReadOverList.do?r="+(+new Date),
		count :20,
		type :"post",
		...
		if(total && data){
			...
			for(var i = 0,j = data.length;i<j;i++){
				...
				if(ReceiveStu.finishTime==null){
					...
					html+='<td><a href="javascript:;"data-stuRecId="'+ReceiveStu.workReceiveStuId+'" class="newHandle readOver">批阅</a></td>';
					$("#pageBody").html(html);
		}
...
$("#pageBody").on("click",".readOver",function(){
	var recStuId=$(this).attr("data-stuRecId");
	location.href="${root}/homework/readByStudentPre.do?homeworkId=${workId}&workReceiveStuId="+recStuId;
