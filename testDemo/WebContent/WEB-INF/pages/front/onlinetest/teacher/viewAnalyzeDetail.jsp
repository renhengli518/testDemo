    ...
    <%@include file="../../../common/fixedRight.jsp"%>
       ...
       <div class="content">
          <div class="content-in">
              <div class="breadCrumb">
                <a href="javascript:;">测试任务</a><span class="nextlevel">></span><a href="javascript:;">统计</a><span class="nextlevel">></span><span class="currentLevel">查看详细</span>
              </div>
			  <!-- 数据列表 -->
	 ...
	 <script type="text/javascript">
      ...
      function bindSpecifyOptionSatistics($elem,examTaskId,examQstId){
 		 ...
 		 $.ajax({                                                                                                                                            
 				url		:	'${root}/teacherTest/getExamQstOptionStatisticsByExamQstId.do',
 				cache	:	false, 
 				type    :   "post",
 				data	:	{
