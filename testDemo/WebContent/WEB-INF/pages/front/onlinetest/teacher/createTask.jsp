...
<script>
   ...
   $(function(){
	   ...
	   $.get("${root}/commons/selectStudentByTeacher.do?userId="+userId,function(treeData){
		   et = eTree.init({
				"id": "stuTree",
				"data": treeData,
				"showParam": "name",
	   ...
	   $(".toSave").click(function(){
		   ...
		   if("${isedit}" == "true"){
			   ...
			   $.post("${root}/teacherTest/finishCreateTask.do",param,function(data){
