...
<body class="mainIndex">
       ...
       <div class="content">
          <div class="content-in">
              <div class="breadCrumb">
                <a href="javascript:;">测试任务</a><span class="nextlevel">></span><a href="javascript:;">统计</a><span class="nextlevel">></span><span class="currentLevel">查看答题</span>
              </div>
			  <!-- 数据列表 -->
			         ...
			         <div class="borderBox pd20">
			            ...
			            <c:if test="${q.type == 'SINGLE_CHOICE' ||  q.type == 'MULTI_CHOICE' || q.type == 'JUDEMENT'}">
			               ...
			               <c:if test="${q.contentVideo != null }">
					        ...
					        <span class="fontBold">  正确答案：  <span class="mr40"> ${q.answer} </span>  学生选择：<span class="mr40"> ${q.myAnswer} </span>         
    ...
    <script type="text/javascript">
       ...
       function bindKnowledgeInfoById($elem,examQuestionId){
			$.ajax({                                                                                                                                            
				url		: '${root}/teacherTest/getExamQstRKnowledgeInfoByExamQstId.do',                                                                    
				cache	:	false,                                                                                                                                     
