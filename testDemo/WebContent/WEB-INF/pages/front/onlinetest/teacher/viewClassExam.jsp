       ...
       <div class="content">
          <div class="content-in">
              <div class="breadCrumb">
                <a href="javascript:;">测试任务</a><span class="nextlevel">></span><span class="currentLevel">查看测试 </span>
              </div>
			  <!-- 数据列表 -->
			  <div class="borderBox gn-bgWhite pd20">
                  ...
                  <ul class="commonUl descCommon clearfix">
                     <li>
                      <label>布置时间：</label><span class="c888"><fmt:formatDate value="${examTaskView.createTime}" pattern="yyyy-MM-dd HH:mm"/></span>
                    </li>
                    <li>
                      <label>年级：</label><span class="c888">${examTaskView.classlevelName}</span>
                    </li>
                    <li>
