   ...
   <%@include file="../../../common/nav.jsp"%>
    ...
    <script  type="text/javascript">
      $(document).ready(function(){
    	 ...
    	 $("#exportData").click(function(){
    		...
    		$.post(url, obj, function(data){
    			if(data.result){
    				window.location.href = "${root}/schoolTest/exportStatisticsUrl.do";
    			}else{
    				Win.alert("导出失败！");
    			}
    		});
      ...
      function bindStatistics(){
    	var examTaskId = '${examTaskView.examTaskId}';
    	var url = "${root}/schoolTest/getExamStatisticsByClass.do";
    	  ...
    	  $.post(url, obj, function(data){
    		  if(data != null && data.length > 0){
				 ...
				 for(var i = 0; i < loop; i++){
				    ...
				    /* if((i+1)%colCnt== 0){
				    	console.log(i+1);
				    	title += '<li><span class="quesNo" style="font-weight:bold">题号</span>';
					    title += '<span class="theRate" style="font-weight:bold">正确率</span></li>';
				    } */
      ...
      function viewAnswer(baseUserId){
 		 var examTaskId = '${examTaskView.examTaskId}';
 		 var url = "${root}/schoolTest/toViewExamAnswer/"+examTaskId+"/"+baseUserId+".html";
 		 window.open(url, "_blank");
      }
