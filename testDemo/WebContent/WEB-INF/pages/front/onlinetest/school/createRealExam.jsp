...
<body class="editQuestion">
	...
	<%@include file="../../../common/queNav.jsp"%>
     <div class="editQues">
        <div>
          <a href="${root}/questionLib/toSharedLib.html">题库</a><span class="nextArrow">&nbsp;&gt;&nbsp;</span><a href="${root}/schoolTest/toRealExam.html">真题试卷</a>
           ...
           <span class="currentLevel">创建试卷</span>
        </div>
        ...
        <form name="addForm" id="addForm" method="post" >
        	...
        	<input type="hidden" id="examId" name="examId" value="${examId}"></input>
	         <div class="editQuesContent mt20">
			     <p class="LH36">
			       <span class="W90"><b class="red">*</b>试卷名称：</span><input id="examTitle"  name="examTitle" type="text" class="W470"><br/>
			       <span class="W90"><b class="red">*</b>地区</span>
			        <select class="newSel w160 mr30" id="areaName" name="areaName">
			          
			        </select>
			        <span class="W90"><b class="red">*</b>年份</span>
			        <select class="newSel w160 mr30" id="year" name="year">
			       ...
			       <select class="newSel w160 mr30" id="examtypeOpts" name="examtype">
						<option value="0">请选择 </option>
			       ...
			       <select class="newSel w160 mr30" id="semesterOption"  name="semesterOpts">
						<option value="0">请选择 </option>
			       ...
			       <select class="newSel w160 mr30" id="classLevelOption" name="classlevelOpts">
			         <option value="0">请选择 </option>
			       </select>
			        <span class="W90"><b class="red">*</b>学科</span>
			       <select class="newSel w160 mr30" id="subjOption" name="disciplineOpts" >
			         <option value="0">-- 请选择 --</option>
			       </select><br/>
			       <span class="W90"><b class="red">*</b>答题时长</span>
			       <input type="text" placeholder="请输入答题时长" id="answerTime"  name="answerTime">&nbsp;分钟<span class="c888 ml10">最多输入三位数</span>
			       <br/>
			       <span class="W90"><b class="red">*</b>试卷总分</span>
			       <input type="text" placeholder="请输入试卷总分" id="scoreInput"  name ="scoreInput">&nbsp;分<span class="c888 ml10">最多输入三位数</span><br/>
		...
		<ul>
			...
			<li class="center mt30">
				<button class="btn bigBtn saveAndSubmit mr20" onclick="tosetscore()" style="margin-bottom: 20px;">下一步，设置题目分值</button> 
     ...
     <script type="text/javascript" src="${root}/biz/js/createRealExam.js" ></script>
     <script type="text/javascript"> 
     /***进行音视频的上传操作**/
     function initSwf(id){
     	 var params="";
