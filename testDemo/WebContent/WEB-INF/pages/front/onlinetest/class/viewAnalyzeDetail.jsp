...
<body class="mainIndex">
       ...
       <div class="content">
          <div class="content-in">
              <div class="breadCrumb">
                <a href="javascript:;">测试</a><span class="nextlevel">></span><a href="javascript:;">统计</a><span class="nextlevel">></span><span class="currentLevel">详细统计</span>
              </div>
			  <!-- 数据列表 -->
    ...
    <script type="text/javascript">
      ...
      function bindSpecifyOptionSatistics($elem,examTaskId,examQstId){
 		 ...
 		 $.ajax({                                                                                                                                            
 				url		:	'${root}/classTest/getExamQstOptionStatisticsByExamQstId.do',
 				cache	:	false, 
 				type    :   "post",
 				data	:	{
