...
<!-- 智能选题 --> 
    <div class="clearfix floatWrap withBorderTop select-exercise-box"  style="border-top-color:#d5f2df;" id="box3">
                <div class="mainLeft">
...
<script type="text/javascript">
	...
	function getznxt(){
		...
		$.post("../teacherTest/searchIntelligenceList.do?subjectId="+ subjectId + "&semesterId=" + semesterId+"&"+param,function(result) {
					//			$("#subjOption").html(html);  
							$("#step1").hide();
							$("#step2").show();
							formZnList(result,result.length);
