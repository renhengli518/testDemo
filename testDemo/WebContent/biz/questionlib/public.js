...
function bindKnowledgeBySemesterAndDiscipline(semesterId,disciplineId){
	var url ="/OnlineTest/commons/getAllBaseKnowledgeBySemesterAndDiscipline.do?baseSemesterId="+semesterId+"&baseDisciplineId="+disciplineId;
	$.get(url , function(result){
		$("#knowledgeOpts").empty();
...
function bindSubKnowledgeByParentId(parentId,callback){
	var url ="/OnlineTest/commons/getSubKnowledgeByParent.do?parentId="+parentId;
	$.get(url , function(result){
...
function bindDifficulty(difficulty){
	...
	$("#difficultyOpts").append("<option value='EASY'>容易</option>");
	$("#difficultyOpts").append("<option value='LITTLE_EASY'>较易</option>");
	$("#difficultyOpts").append("<option value='NORMAL'>一般</option>");
	$("#difficultyOpts").append("<option value='LITTLE_DIFFICULT'>较难</option>");
	$("#difficultyOpts").append("<option value='DIFFICULT'>困难</option>");
